...
#### [3. ASP. NET Core Web API secured by Azure Active Directory](#asp-net-core-web-api-secured-by-azure-active-directory)
#### [4. ASP. NET Core Web API secured by Azure Active Directory B2C](#asp-net-core-web-api-secured-by-azure-active-directory-b2c)
#### [5. UWP app secured by Azure Active Directory](#UWP-app-secured-by-azure-active-directory)
#### [6. UWP app secured by Azure Active Directory B2C](#UWP-app-secured-by-azure-active-directory)
...
# ASP. NET Core Web API secured by Azure Active Directory B2C with Authorization Data Storage
