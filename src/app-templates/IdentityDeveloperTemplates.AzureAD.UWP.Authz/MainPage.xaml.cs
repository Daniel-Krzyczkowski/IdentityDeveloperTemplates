using IdentityDeveloperTemplates.AzureAD.UWP.Authz.Services.Api;
using IdentityDeveloperTemplates.AzureAD.UWP.Authz.Services.Api.Interfaces;
...
namespace IdentityDeveloperTemplates.AzureAD.UWP.Authz
{
    /// <summary>
